...
class Galleries1990(models.Model):
    ...
    clay = models.TextField(blank=True) # Field renamed to remove spaces. Field name made lowercase. This field type is a guess.
    ...
    lat = models.TextField(blank=True) # This field type is a guess.
    lan = models.TextField(blank=True) # This field type is a guess.
    neighborhood = models.TextField(blank=True) # This field type is a guess.
    media = models.TextField(blank=True) # This field type is a guess.
    class Meta:
